...
export function LibraryPreview() {
    return (
        <section className="section-padding bg-[#0A1118] relative overflow-hidden">
            {/* Background Gold Accents */}
            <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-primary/5 rounded-full blur-[100px] pointer-events-none" />
            <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-navy-800/20 rounded-full blur-[100px] pointer-events-none" />
            ...
            <div className="section-container relative z-10">
                <div className="flex flex-col lg:flex-row gap-12 lg:gap-20 items-center">
                    ...
                    >
                        ...
                        <p className="text-navy-200 font-body text-lg mb-8 leading-relaxed max-w-xl mx-auto lg:mx-0">
                        ...
                        <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 mb-10">
                            <div className="flex items-center gap-2 text-navy-100 font-medium">
                                <FileText className="h-5 w-5 text-primary" />
                                <span>Textbooks & Manuals</span>
                            </div>
                            <div className="hidden sm:block w-1.5 h-1.5 rounded-full bg-navy-600" />
                            <div className="flex items-center gap-2 text-navy-100 font-medium">
                    ...
                    >
                        <div className="grid grid-cols-2 gap-4 sm:gap-6 relative">
                            ...
                            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-16 h-16 rounded-full bg-navy-900 border border-primary/20 flex items-center justify-center shadow-gold-glow z-20 hidden sm:flex">
                            ...
                            {featuredBooks.map((book, idx) => (
                                ...
                                >
                                    <div className="aspect-[3/4] rounded-xl overflow-hidden relative shadow-card border border-navy-500/50 group-hover:border-primary/50 transition-colors">
                                        ...
                                        />
                                        <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-navy-950 via-navy-900/80 to-transparent p-4 sm:p-5 translate-y-2 group-hover:translate-y-0 transition-transform">
                                            <Badge variant="outline" className="bg-navy-950/80 backdrop-blur-md text-[10px] mb-2 border-primary/30 text-primary-light">
                                                {book.type}
                                            </Badge>
