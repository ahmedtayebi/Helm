                ...
                <div className="section-container relative z-10">
                    ...
                    <div className="flex items-center justify-between mb-10">
                        <div>
                            ...
                            <p className="text-slate-500 dark:text-navy-300 mt-2">Editor&apos;s picks and highly recommended readings.</p>
                        </div>
                                ...
                                <AnimatePresence mode="popLayout">
                                    ...
                                    {displayResources.length === 0 && (
                                        ...
                                        >
                                            ...
                                            <p className="text-slate-500 dark:text-navy-300">We couldn&apos;t find any resources in this specific category.</p>
                                        </motion.div>
                                    )}
                                </AnimatePresence>
                            </div>
                            ...
                            <div className="bg-white/50 dark:bg-navy-900/50 border border-slate-200 dark:border-navy-600 rounded-2xl p-6 sticky top-28">
                                ...
                                <div className="space-y-4">
                                    {popularThisWeek.map((resource, idx) => (
                                        <Link key={resource.id} href={`/library/search`} className="group flex gap-4 items-start p-3 -mx-3 rounded-xl hover:bg-slate-100 dark:hover:bg-navy-800 transition-colors">
                                ...
                                <Button variant="ghost" className="w-full mt-6 text-slate-500 dark:text-navy-300 hover:text-[#0D1B2A] dark:hover:text-white border border-dashed border-slate-300 dark:border-navy-600">
                                    View Full Rankings
                                </Button>
                            </div>
                        </aside>
