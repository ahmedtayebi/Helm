...
export function CommunityPreview() {
    return (
        <section className="section-padding bg-navy-900 border-b border-navy-500/30">
            <div className="section-container">
                ...
                >
                    ...
                    <p className="text-navy-200 font-body text-lg max-w-2xl">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
                    ...
                    >
                        ...
                        <div className="space-y-4">
                            {webinars.map((webinar) => (
                                <div
                                    key={webinar.id}
                                    className="p-5 rounded-2xl glass border border-navy-500/50 hover:border-primary/50 transition-colors group flex flex-col sm:flex-row gap-4 sm:gap-6 sm:items-center cursor-pointer"
                                >
                                    <div className="flex-shrink-0 text-left sm:text-center p-3 sm:px-4 sm:py-3 bg-navy-950/50 rounded-xl border border-navy-600/50 min-w[100px]">
                                        <span className="block text-primary font-bold text-lg leading-none mb-1">
                                            {webinar.date.split(" ")[1].replace(",", "")}
                                        </span>
                                        <span className="block text-xs text-navy-300 font-medium uppercase tracking-wider">
                                            {webinar.date.split(" ")[0]}
                                        </span>
                                    </div>

                                    <div className="flex-1">
                                        <h4 className="text-white font-medium text-lg leading-tight mb-2 group-hover:text-primary transition-colors">
                                            {webinar.title}
                                        </h4>
                                        <div className="flex flex-wrap items-center gap-x-4 gap-y-2 text-sm text-navy-300">
                                    ...
                                    <div className="hidden sm:flex self-center w-10 h-10 rounded-full border border-navy-500 flex-shrink-0 items-center justify-center group-hover:bg-primary/10 group-hover:border-primary transition-all">
                                        <ArrowRight className="h-4 w-4 text-navy-300 group-hover:text-primary" />
                                    </div>
                                </div>
                            ))}
                        </div>
                    ...
                    >
                        <div className="absolute inset-0 bg-gradient-to-br from-navy-800 to-navy-950 rounded-3xl border border-navy-500/50 shadow-2xl overflow-hidden p-8 flex flex-col justify-between">
                            ...
                            <p className="text-xl md:text-2xl font-display text-white italic leading-relaxed relative z-10 mb-8">
                            ...
                            <div className="flex justify-between items-end relative z-10">
                                <div className="flex items-center gap-4">
                                    <div className="w-14 h-14 rounded-full bg-navy-600 border-2 border-primary/50 overflow-hidden">
                                    ...
                                    <div>
                                        <h5 className="text-white font-bold text-lg">Yassine B.</h5>
                                        <p className="text-navy-300 text-sm">Well Completion Engineer</p>
                                    </div>
                                </div>
